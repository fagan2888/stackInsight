...
cmd_posts_pr = "ssh ubuntu@ip-10-0-0-13 /usr/local/spark/bin/spark-submit \
...
cmd_pr_spark = "ssh ubuntu@ip-10-0-0-13 /usr/local/spark/bin/spark-submit \
   --master spark://ip-10-0-0-13:7077 \
   --deploy-mode cluster \
   --executor-memory 20G \
   --driver-memory 8G \
...
cmd_df_join = "ssh ubuntu@ip-10-0-0-13 /usr/local/spark/bin/spark-submit \
   --master spark://ip-10-0-0-13:7077 \
   --deploy-mode cluster \
   --executor-memory 20G \
   --driver-memory 8G \
